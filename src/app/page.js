"use client"
import {useHomeSlidersQuery} from "./apis/home-sliders/useHomeSlidersQuery"
import HeaderSliders from "./components/home/HeaderSliders";
export default function Home() {
  const {data} = useHomeSlidersQuery();
  return (
    // <div className="grid items-center justify-items-center min-h-screen  gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)] bg-slate-00">
    ...
    //   </section>
    // </div>
    <div className="reltive w-full home-content">
      <HeaderSliders/>
    </div>
  );
}
