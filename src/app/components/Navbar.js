...
export default function Navbar() {
    useEffect(() => console.log("render from client componsnte") , [])
    return (
        <>
                ...
                <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div className="flex space-x-4">
                            ...
                            <Link href={"/"} className="rounded-md  px-3 py-2 text-sm font-medium text-white">Home Page</Link>
                            <Link href={"/about"} className="rounded-md  px-3 py-2 text-sm font-medium text-white">About</Link>
                            <Link href={"/blogs"} className="rounded-md  px-3 py-2 text-sm font-medium text-white">Blogs</Link>
                        </div>
                        </div>
                    </div>
                    </div>
